...
const Icons = {
  ...
  Postman: (
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M94.7 46.7L71.9 69.5l-3.6-3.6 22.8-22.8L94.7 46.7zM71.3 68.3l-2.8 2.8c-1.7 1.7-4.1 2.4-6.4 1.9L44.5 90.4c-.7.7-1.7 1.1-2.6 1.1-.9 0-1.9-.4-2.6-1.1l-5.1-5.1c-1.4-1.4-1.4-3.7 0-5.1l17.6-17.5c-.5-2.3.2-4.7 1.9-6.4l2.8-2.8 14.8 14.8zm-19.1-6L45 69.5l4.6 4.6 7.2-7.2-4.6-4.6zM64.1 57.2l6.6 6.6-9.3 9.3-6.6-6.6 9.3-9.3zM48 81.9l-8.3-8.3 5.1-5.1 8.3 8.3-5.1 5.1zm3.7-3.7l3.5 3.5c.8.8.8 2.1 0 2.9l-5.5 5.5c-.8.8-2.1.8-2.9 0l-3.5-3.5c-.8-.8-.8-2.1 0-2.9l5.5-5.5c.8-.8 2.1-.8 2.9 0z" fill="#fff"/>
    </svg>
  ),
  "MVT Architecture": (
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
  ...
  "REST APIs": (
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="14" y="44" width="100" height="28" rx="6" fill="#f43f6e" opacity="0.15"/>
      <rect x="14" y="44" width="100" height="28" rx="6" fill="none" stroke="#f43f6e" strokeWidth="1.5"/>
      <text x="20" y="63" fontFamily="monospace" fontSize="13" fill="#fb7aa0" fontWeight="bold">GET /api/v1/</text>
      <rect x="14" y="80" width="100" height="22" rx="5" fill="#4ade80" opacity="0.12"/>
      <text x="20" y="95" fontFamily="monospace" fontSize="10" fill="#4ade80">200 OK</text>
      <circle cx="108" cy="30" r="8" fill="#f43f6e" opacity="0.7"/>
      <text x="104" y="34" fontFamily="monospace" fontSize="9" fill="#fff">~</text>
    </svg>
  ),
  "Responsive Design": (
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
...
const techGrid = [
  ...
  { name: "REST APIs",          category: "backend",  brand: "#f43f6e" },
  ...
  { name: "Postman",            category: "tools",    brand: "#FF6C37" },
